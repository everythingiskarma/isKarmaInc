...
$(document).on("keyup", "#searchInput input", function() {
    ...
    delay(function() {
        ...
        processRequest('api/static-php-content-search.php', requestData, successCallback, errorCallback);
...
$(document).on("click", "#searchResults li", function() {
    ...
    processRequest('api/static-php-content.php', requestData, successCallback, errorCallback);
