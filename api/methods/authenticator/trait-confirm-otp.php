...
require_once 'trait-register-gatekeeper-account.php'; // provides trait RegisterGatekeeperAccount
require_once 'trait-login-user.php'; // provides trait LoginUser
require_once 'trait-update-otp-attempts.php'; // provides trait UpdateOTPAttempts
